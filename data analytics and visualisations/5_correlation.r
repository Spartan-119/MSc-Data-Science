...
# Plot box plot correlation between normalized_spend and normalized_famsize
boxplot(normalized_spend ~ normalized_famsize, 
    main = "Association between Normalized Spend and Normalized Family Size", 
    xlab = "Normalized Spend", ylab = "Normalized Family Size",
    horizontal = TRUE, col = "pink",
    cex.lab = 1.5, font.lab = 2)
